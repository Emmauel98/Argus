...
const PricingOne = ({ data, name }) => {
  return (
    <>
      <div
        className=" lg:w-[20vw] bg-gradient-to-t from-[#FFFFFF] top-[#F9F9FA]
       ring-2 ring-[#E5E7EB] pt-[2rem] flex justify-center lg:h-[60vh]
       rounded-xl  h-[60vh] mx-[1rem] lg:mx-0 md:h-[42vh]
       "
      >
        <div className=" w-[90%]">
              ...
              return (
                <div key={id} className="flex gap-[1rem] mb-[.6rem]">
                  <div className=" flex items-center">
                    <img src={arrowright} alt="" className="lg:w-[1.3vw] w-[4vw]" />
                  </div>
